# Integrating WAX Expresstrade using NodeJS
...
- [NodeJS](https://nodejs.org/en/) and NPM for managing packages  
I suggest using NodeJS 8.9.4 or higher for the best possible stability and package support  
